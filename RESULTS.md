...
- **2.5-bit**: 3-bit outlier channels and 2-bit non-outlier channels, corresponding to effective bitwidth (32 × 3 + 96 × 2 + 2 × 16) / 128 = 2.5
- **3.5-bit**: 4-bit outlier channels and 3-bit non-outlier channels, corresponding to effective bitwidth (32 × 4 + 96 × 3 + 2 × 16) / 128 = 3.5
